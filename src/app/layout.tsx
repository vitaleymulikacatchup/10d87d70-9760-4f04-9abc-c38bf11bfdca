...
export const metadata: Metadata = {
  title: "Grand Vista Hotel - Luxury 5-Star Hospitality Experience",
  description: "Experience unparalleled luxury at Grand Vista Hotel. Premium suites, exceptional service, and world-class amenities await your perfect stay.",
  keywords: "luxury hotel, 5-star hotel, premium suites, hospitality, luxury accommodation, hotel booking, concierge service",
  metadataBase: new URL("https://grandvistahotel.com"),
  alternates: {
    canonical: "https://grandvistahotel.com"
  },
  openGraph: {
    title: "Grand Vista Hotel - Luxury 5-Star Hospitality",
    description: "Experience unparalleled luxury at Grand Vista Hotel with premium suites and exceptional service.",
